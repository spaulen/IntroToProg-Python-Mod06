...
# SPaulen, 11.23.2020, Added code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def write_data_to_file(file_name, list_of_rows):
        objFile = open(file_name, "w")  # This saves the text file to same py location
        for row in list_of_rows:
...
class IO:
    ...
    def input_new_task_and_priority():
        task = str(input("What is the Item Name? - ")).strip()
        priority = str(input("What is the Item Value? - ")).strip()
    ...
    def print_current_tasks_in_list(list_of_rows):
        print("******* The current Items in Home Inventory are: *******")
        for row in list_of_rows:
